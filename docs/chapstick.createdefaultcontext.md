...
[Home](./index.md) &gt; [@suds-cli/chapstick](./chapstick.md) &gt; [createDefaultContext](./chapstick.createdefaultcontext.md)
...
```typescript
export declare function createDefaultContext(): StyleContext;
```
**Returns:**
